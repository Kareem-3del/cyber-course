...
const ROADMAP: Tier[] = [
  {
    ...
    status: "success",
    groups: [{ title: { ar: "المبادئ الجوهرية", en: "Core principles" }, slugs: ["mindset", "lab-setup", "linux-fundamentals", "windows-fundamentals", "networking-basics"] }],
  },
  {
    key: "core", number: "II",
    title: { ar: "العمليات الأساسية", en: "Core Operations" },
    description: { ar: "المهارات اليومية لكل من يعمل في الأمن: استطلاع، فحص، أدوات، دفاع أساسي، وحوكمة.", en: "Day-to-day skills every security professional needs: recon, tooling, baseline defense, and governance." },
    level: { ar: "متوسط", en: "Intermediate" },
    duration: { ar: "≈ 22 ساعة", en: "≈ 22 hours" },
    status: "info",
    groups: [
      { title: { ar: "الاستطلاع والأدوات", en: "Recon & tooling" }, slugs: ["recon", "osint-fundamentals", "scanning", "burp-mastery", "toolkit", "exploit-handbook", "cve-hunting"] },
      { title: { ar: "العنصر البشري والأساسيات", en: "Human factor & basics" }, slugs: ["social-engineering", "crypto", "wireless", "password-cracking"] },
      { title: { ar: "دفاع — الأساسيات", en: "Defense — basics" }, slugs: ["soc-analyst-day1", "hardening", "compliance", "email-phishing-analysis", "evidence-chain-of-custody"] },
      { title: { ar: "العمليات والاستخبارات", en: "Operations & Intel" }, slugs: ["threat-intel-fundamentals", "cyber-law-authorities", "pentest-reporting"] },
    ],
  },
  {
    key: "advanced", number: "III",
    title: { ar: "العمليات المتقدمة", en: "Advanced Operations" },
    description: { ar: "تخصص حقيقي في كل مجال: الويب، الأطر البرمجية، الشبكة، AD، السحابة، نقاط النهاية، IoT، وكشف التهديدات.", en: "Real specialization across web, frameworks, network, AD, cloud, endpoints, IoT, and threat detection." },
    level: { ar: "متقدم", en: "Advanced" },
    duration: { ar: "≈ 50 ساعة", en: "≈ 50 hours" },
    status: "warning",
    groups: [
      { title: { ar: "الويب وAPI", en: "Web & API" }, slugs: ["web-attacks", "api-security", "advanced-web"] },
      { title: { ar: "أمن الأطر البرمجية", en: "Framework security" }, slugs: ["nodejs-express-security", "nestjs-security", "react-security", "nextjs-security", "angular-security"] },
      { title: { ar: "الشبكة واللاسلكي", en: "Network & wireless" }, slugs: ["network-attacks", "wifi-deep"] },
      { title: { ar: "Active Directory والهوية", en: "Active Directory & identity" }, slugs: ["advanced-ad", "adcs-attacks", "bloodhound-mastery", "mfa-saml-oauth-attacks"] },
      { title: { ar: "السحابة", en: "Cloud" }, slugs: ["cloud", "aws-attack-chains", "azure-attacks", "m365-entra-attacks"] },
      { title: { ar: "نقاط النهاية وتصعيد الصلاحيات", en: "Endpoints & privilege escalation" }, slugs: ["server-attacks", "linux-privesc", "windows-privesc", "post-exploitation", "lateral-movement", "evasion", "initial-access", "opsec-offensive", "target-selection", "full-attack-scenario"] },
      { title: { ar: "IoT والأجهزة المادية", en: "IoT & physical" }, slugs: ["mobile-iot", "usb-network-implants", "usb-attack-lab"] },
      { title: { ar: "الفريق الأزرق المتقدم", en: "Advanced Blue Team" }, slugs: ["detection", "siem-detection-engineering", "threat-hunting", "incident-response", "dfir-triage", "malware-analysis", "windows-forensics", "network-forensics", "memory-forensics"] },
    ],
  },
  {
    ...
    duration: { ar: "≈ 45 ساعة", en: "≈ 45 hours" },
    status: "error",
    groups: [
      ...
      { title: { ar: "ICS والبنية التحتية الحرجة", en: "ICS & critical infrastructure" }, slugs: ["ics-scada-protocols", "critical-infrastructure"] },
      { title: { ar: "تكتيكات الدول والاستخبارات", en: "Nation-state & intelligence" }, slugs: ["state-actor-tradecraft", "attribution", "mobile-spyware"] },
      { title: { ar: "قواعد المعرفة والبرامج", en: "Knowledge bases & programs" }, slugs: ["cve-catalog", "purple-team"] },
    ],
  },
];
