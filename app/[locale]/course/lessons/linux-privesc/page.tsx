...
export default function Page() {
  return (
    <LessonShell slug="linux-privesc">
      <L
        ar={<>
          <Section title="لماذا يمنحك صدفة عادية صلاحيات root أحياناً؟">
            <Analogy>
              تخيل بناية مكاتب. أنت موظف زائر، عندك بطاقة تفتح الردهة فقط. تصعيد الصلاحيات هو إيجاد باب جانبي
              تركه أحدهم مفتوحاً، أو أن نظام التحكم في الأبواب يثق ببطاقتك أكثر مما يجب. الفرق بينك وبين root
              في معظم الحالات ليس ثغرة kernel، بل خطأ بسيط في الإعدادات.
            </Analogy>
            <p>
              تصعيد الصلاحيات في Linux نادراً ما يكون 0-day. غالباً هو SUID مفقود، sudo rule مفتوح، أو script
              يعمل كـ cron بصلاحيات عالية ويثق في PATH. هذا الدرس يغطي ما يبحث عنه المهاجم بعد كل أول shell.
            </p>
          </Section>
...
# انتظر تشغيل cron أو script`}</Code>
          ...
          <Callout kind="danger" title="تحذير قانوني">
            هذه التقنيات ضد أنظمة لا تملكها = جريمة فيدرالية. كل مثال هنا يفترض مختبراً معزولاً أو نظاماً
            عندك إذن خطّي صريح باختباره.
          </Callout>
