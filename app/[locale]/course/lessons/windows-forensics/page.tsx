      ...
      <L
        ar={<>
          <Section title="فن قراءة ويندوز — البيانات تتكلّم">
            <p>كل عملية، تسجيل دخول، اتصال شبكة، فتح ملف — يترك أثراً في مكان معروف. الفرق بين محقّق متمرّس و مبتدئ ليس الأدوات — بل <b>أين ينظر و بأي ترتيب</b>. ويندوز يحوي ~40 مصدر artifact، 6 منها تكفي لـ 80% من القضايا.</p>
            <Analogy>ويندوز كمنزل فيه آلاف العدّادات. عدّاد الكهرباء يخبرك بالاستهلاك العام، لكن إذا عرفت أن العدّاد الفرعي للمطبخ ارتفع فجأة الساعة 3 صباحاً، تعرف من كان مستيقظاً و ماذا كان يفعل.</Analogy>
          </Section>
          ...
          <Section title="Sysmon — الـ EDR المجاني الذي يجب أن يكون على كل host">
            <p>Sysmon من Sysinternals يضيف &gt;20 نوع حدث ضرورية لا يسجّلها ويندوز افتراضياً. مع config جيد (SwiftOnSecurity أو Olaf Hartong) يصبح أقوى من EDRs تجارية للكشف.</p>
