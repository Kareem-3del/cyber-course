...
export default function Page() {
  return (
    <LessonShell slug="mindset">
      <L
        ar={<>
          <Section title="ما الذي يفصل الـ Hacker الحقيقي عن غيره؟">
            <p>قبل أن نتعلم أي أداة، يجب أن نفهم أن الاختراق ليس «كتابة أوامر» بل <b>طريقة تفكير</b>. الـ Hacker المحترف لا يبحث عن باب ليفتحه، بل يدرس البيت كله — النوافذ، أنبوب الغاز، عامل النظافة، ساعي البريد — حتى يجد الطريق الأقل حراسة.</p>
            <Analogy>تخيّل أن لديك خزينة كبيرة في بيتك. اللص الذكي لا يحاول كسر الباب الحديدي، بل يبحث: هل تركتَ المفتاح تحت السجادة؟ هل ابن الجيران يعرف الرقم السري؟ هل النافذة الخلفية مفتوحة؟ <b>السطح الأوسع للهجوم = أكبر فرصة للنجاح</b>.</Analogy>
          </Section>
          ...
          <Section title="سلسلة الهجوم — Cyber Kill Chain">
            ...
            <Callout kind="info" title="لماذا تهمنا هذه السلسلة؟">لأن كسر أي حلقة = فشل الهجوم بأكمله. الدفاع الذكي يضع طبقة في كل مرحلة.</Callout>
          </Section>
          ...
          <Section title="الأخلاقيات و القانون">
            <Callout kind="danger" title="القاعدة الذهبية">لا تختبر هدفاً لا تملك <b>إذناً مكتوباً</b> عليه. اختراق نظام بدون تفويض جريمة في كل الدول و قد تصل العقوبة لسنوات سجن.</Callout>
            <ul>
