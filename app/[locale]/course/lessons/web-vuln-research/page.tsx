      ...
      <L
        ar={<>
          ...
          <Section title="منهجية البحث — هرم الإيجاد">
            <p>الباحثين الجادين مش بيبدأوا بـ <span className="eng">fuzzer</span> عشوائي. بيمشوا في هرم — كل طبقة أرخص بكتير من اللي بعدها. ابدأ من فوق ولأسفل:</p>
            <TwoCol>
          ...
          <Section title="Patch Diffing عملياً — الطريق الأقصر للـ n-day">
            <p>أكتر من 60% من &quot;الـ 0-days&quot; اللي بيستخدمها مهاجمين الدول دي مش 0-days أصلاً — هي n-days. ثغرات طلعلها patch بس الضحية ما حدّثش. الفرق بينك وبين APT هو مين بيقرا الـ patch أسرع. اللعبة في السرعة.</p>
          ...
          <Section title="Variant Analysis — كيف تحوّل ثغرة إلى عشر">
            <p>لما تلاقي ثغرة، اسأل تلات أسئلة فوراً قبل ما تكتب التقرير:</p>
            <ol>
              <li><b>حصلت ليه؟</b> إيه الفرضية الغلط في دماغ المطوّر؟ (مثلاً: &quot;الـ <span className="eng">URL parser</span> بيشوف نفس اللي عيني بتشوفه&quot;).</li>
              <li><b>الفرضية دي متكررة فين تاني؟</b> grep لنفس النمط في الـ codebase وفي مشاريع منافسة.</li>
              <li><b>إيه الـ root API الضعيف؟</b> لو الموضوع في <span className="eng">urllib.parse</span> نفسها، يبقى كل مشروع بيستخدمها معرّض. اطلع للجذر.</li>
            </ol>
