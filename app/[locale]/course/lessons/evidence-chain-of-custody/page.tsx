      ...
      <L
        ar={<>
          <Section title="ليه سلسلة الحفظ مش بيروقراطية فاضية">
            <p>أي تحقيق فيدرالي ممكن يطلع في محكمة. الدليل اللي ما تقدرش تثبت سلامته — مصدره، مين لمسه، إمتى، اتخزّن إزاي — <b>هيترفض</b>. القضية تتهد رغم إن الدليل التقني قوي.</p>
            <Analogy>عيّنة الدم في المعمل الجنائي. لو العيّنة في التلاجة الصحيحة، وكل واحد استلمها وقّع، وفيها رقم تسلسل واضح — القاضي بيقبلها. ناقص توقيع واحد بس؟ ترفض. التقنية ما بتنقذش سوء التوثيق.</Analogy>
            <Callout kind="danger" title="القاعدة الذهبية">
              <b>عامل كل دليل كأنه هيتقدّم قدّام محلّفين</b> — حتى لو فاكر إن الحادث "بسيط". قرار التحوّل للمسار الجنائي بييجي بعدين، والدليل اللي اتلوّث ما يرجعش.
            </Callout>
          </Section>
...
F:\\tools\\winpmem.exe - | F:\\tools\\nc.exe analyst-host 4444`}</Code>
          ...
          <Section title="أخطاء قاتلة — متعملهاش">
            <ul>
              <li><b>تشغّل النظام «علشان تشوف بيحصل إيه».</b> كل ثانية شغّال = آلاف التغييرات على القرص. حرقت الدليل.</li>
