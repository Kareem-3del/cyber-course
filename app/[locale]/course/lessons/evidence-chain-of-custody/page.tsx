...
export default function Page() {
  return (
    <LessonShell slug="evidence-chain-of-custody">
      <L
        ar={<>
          <Section title="لماذا سلسلة الحفظ ليست بيروقراطية">
            <p>في أي تحقيق فيدرالي قد ينتهي في محكمة. الدليل الذي لا تستطيع إثبات سلامته — مصدره، من لمسه، متى، كيف خُزّن — <b>غير مقبول</b>. القضية تنهار رغم قوة الدليل التقني.</p>
            <Analogy>كعينة دم في معمل جنائي. لو كانت العينة في الثلاجة الصحيحة، مع توقيع كل من تسلّمها، و رقم تسلسل واضح — يستطيع القاضي قبولها. لو نقصت توقيع واحد، تُرفض. التقنية لا تنقذ سوء التوثيق.</Analogy>
            <Callout kind="danger" title="القاعدة الذهبية">
              <b>عامل كل دليل كأنه سيُقدّم أمام محلّفين</b> — حتى لو ظننت أن الحادث "بسيط". القرار بالتحول للمسار الجنائي يأتي لاحقاً، و لا يمكن استرجاع الدليل المُلوَّث.
            </Callout>
          </Section>
...
Volexity Surge Collect — تجاري لكن المعتمد عملياً`}</Code>
          ...
          <Section title="Hashing — قلب Integrity">
            <p>احسب hash <b>قبل</b> الجمع (إن أمكن — على القرص الأصلي عبر write-blocker) و <b>بعد</b>. أي تطابق = الدليل سليم. أي اختلاف = شيء كُتب.</p>
            <Terminal lines={[
              { p: "# قبل الـ image" },
...
F:\\tools\\winpmem.exe - | F:\\tools\\nc.exe analyst-host 4444`}</Code>
          ...
          <Section title="أخطاء قاتلة — لا تفعلها">
            <ul>
              <li><b>تشغيل النظام لرؤية ماذا يحدث.</b> كل ثانية تعمل = آلاف التغييرات على القرص.</li>
              <li><b>توصيل القرص الأصلي بحاسوبك.</b> نظام التشغيل يُحدّث timestamps فوراً. write-blocker أو لا توصيل.</li>
              <li><b>تخزين الدليل على شبكة المؤسسة المعتادة.</b> استخدم evidence-only storage مع ACLs.</li>
              <li><b>تشغيل antivirus على الـ image.</b> AV قد يحذف "malware" — يدمّر الدليل.</li>
              <li><b>عدم توثيق ساعة النظام.</b> اقرأ BIOS clock و قارن مع UTC الحالي. الانحرافات تهدم timeline.</li>
              <li><b>المشاركة في chat عام.</b> كل تواصل عن الدليل يجب أن يكون موثّقاً و في القناة الرسمية.</li>
              <li><b>التأخر في كتابة الـ notes.</b> اكتب notes ميدانية فوراً. الذاكرة تتلاشى، توقيتات تختلط.</li>
            </ul>
          </Section>
        </>}
        en={<>
