...
export default function Page() {
  return (
    <LessonShell slug="usb-network-implants">
      <L
        ar={<>
          <Section title="ليه الـ USB لسه السلاح الأخطر في 2026؟">
            <p>طب لو الشبكة معزولة عن الإنترنت تماماً (air gap)، الـ adversary هيدخل إزاي؟ الجواب الوحيد عمره 16 سنة: USB. من Stuxnet في 2010 لـ Volt Typhoon في 2024، الـ USB هو ناقل العدوى رقم 1 للأهداف اللي "مفصولة عن العالم". اللي معزول مش معناه آمن. معناه إن الناقل لازم يكون فيزيائي.</p>
            <Analogy>الـ air gap حيطة القلعة. الإنترنت بوابة عليها حراسة. الـ USB؟ ده ظرف بريد بيحطّه موظف في جيبه ويعدّي الحيطة من غير ما حد يفتّشه. أي adversary جاد بيستثمر في سؤال واحد بس: "إزاي ندخل عن طريق جيب موظف؟"</Analogy>
            <p>طب ليه لسه في 2026؟
            معندناش technology أحدث؟
            عندنا. بس الفجوة البشرية لسه موجودة، والـ trust في الـ HID class لسه موجود في كل OS، والفضول البشري لسه ثغرة مفتوحة.</p>
            <Callout kind="danger" title="قبل ما تكمّل — قانون مش بيهزر">
          ...
          <Section title="كيف يُنشر USB ملوث في العالم الحقيقي">
            <Step n={1} title="الإسقاط — Drop Attack">
              <p>دراسة جامعة إلينوي 2016 الكلاسيكية: 297 USB اترموا في حرم الجامعة. <b>98% اتاخدوا، 45% اتوصّلوا بكمبيوتر</b>. النسبة بترتفع لو الـ USB عليه ملصق (&quot;سري&quot;، &quot;رواتب 2026&quot;، شعار الجامعة). في العمليات الحقيقية على بيئات حكومية، المكان مش عشوائي — مواقف السيارات، الأسانسيرات (المصاعد)، الكافيتريا. الفضول البشري ثغرة مفتوحة دايماً.</p>
            </Step>
          ...
          <Section title="كيف يعدي USB الـ &quot;Air-Gap&quot; — قصة Stuxnet مختصرة">
            ...
            <Callout kind="info" title="اللي بيحصل فعلياً">
              نظام معزول != نظام آمن.
              معناه إن ناقل العدوى لازم يكون فيزيائي. وده قيد بشري مش تقني.
              - يعني إيه يا حضرتك؟؟
              يعني القيود التقنية بتتحسب بـ "كم عشان نكسرها؟". القيود البشرية بتتحسب بـ "كم عشان نقنع شخص؟".
              التقني أصعب.
              البشري بـ 50 دولار وUSB في موقف العربيات.
            </Callout>
          </Section>
...
hashcat -m 5600 hashes.txt rockyou.txt`}</Code>
            ...
            <Callout kind="info" title="بُص بقى — نقطة مهنية مهمة جداً">
              الخطوات دي مش الفلاشة بتعملها automatically، يا مستجد.
              دي خطوات <b>يدوية</b> الـ operator بينفّذها بعد ما الـ USB بيفتح shell على جهاز داخلي.
              الـ malware مش بياخد مكان المهاجم — بيقعّده على الكرسي بس.
              الباقي شغل بشري. وده اللي بيخلّي الـ APT مكلف. الـ malware ببلاش، الـ operator هو الفلوس.
            </Callout>
          </Section>

          <Section title="الحماية الكامل — كيف تُغلق هذه السلسلة">
          ...
          <Callout kind="warn" title="غلطات الـ junior">
            <ul>
              <li>بيشتري Rubber Ducky بـ 50 دولار وبيفتكر إنه بقى APT. الـ tool أداة. الـ tradecraft هو الشغل.</li>
              <li>بيكتب DuckyScript بـ delays قصيرة جداً. الـ OS بيـ buffer الكيبورد، فالـ commands بتتلخبط في بعض. delay لازم يكون reasonable.</li>
              <li>بيـ drop USB في موقف الشركة من غير ما يحط VID/PID صح — الـ device control هيمنعه قبل ما يشتغل.</li>
              <li>بيستخدم O.MG cable في bid engagement من غير ما يقول للعميل. لو كاميرات الـ CCTV شافت "كبل غريب"، الـ engagement بتنتهي قبل ما تبتدي.</li>
            </ul>
          </Callout>
          ...
          <Section title="الخلاصة الناشفة">
            ...
            <p>اوعى تقول "endpoint بتاعنا حماه EDR".</p>
            <p>الـ EDR بياخد ساعة عشان يعمل alert.</p>
            <p>الـ DuckyScript بياخد 4 ثواني.</p>
