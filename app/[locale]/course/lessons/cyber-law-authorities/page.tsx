      ...
      <L
        ar={<>
          <Section title="ليه المحلّل التقني محتاج يفهم في القانون؟">
            <p>إنت محلّل تقني شاطر.</p>

            <p>- طب يا حضرتك أنا تقني، القانون شغل المحامي مش شغلي.</p>

            <p>اوعى يا مستجد. ده بالظبط نوع التفكير اللي بيحرق القضايا.</p>
            <p>طب لو سحبت log من غير authority؟ لو فتحت mailbox من غير warrant؟ لو كلّمت ضحية في قطاع خاص قبل ما تتكلم مع OGC؟</p>
            <p>القضية بتسقط.</p>
            <p>وإنت شخصياً بتتحاسب.</p>
            <Analogy>
              بُص. تخيّل جرّاح يعرف يقطع كويس، بس ما يعرفش إمتى محتاج موافقة المريض.
              التقنية من غير سلطة قانونية = إنت بتحرق نفسك قبل ما تحرق القضية.
              الـ FBI مش بيقيّم شغلك بـ "نجحت تخترق ولا لأ" — بيقيّمه بـ "هل اللي عملته يصمد قدام محكمة فيدرالية".
            </Analogy>
            <Callout kind="danger" title="اللي بيحصل فعلياً">
              الدرس ده <b>تمهيدي</b>. بيرسملك الخريطة، بس مش بيحلّ مكان OGC ولا AUSA.
              لو واخد قرار حقيقي بناءً على درس على نت، يبقى إنت كده كده بتغلط.
              <b>كل قرار حقيقي = OGC + AUSA + توثيق</b>.
            </Callout>
          </Section>

          <Section title="قصة من الواقع: قضية اتحرقت من خطوة واحدة">
            <Callout kind="warn" title="السيناريو">
              فريق تحقيق فيدرالي وصل لـ C2 server بيتحكّم في botnet. الـ analyst قرر "ياخد فرصة" ويسحب memory dump من السيرفر قبل ما يجيب warrant — السيرفر في dropbox أمريكي والوقت ضيّق.
              اللي حصل فعلياً؟ كل الـ evidence اتعملها suppress تحت 4th Amendment. الـ defendants خرجوا.
              والـ analyst اتنقل برّه الفريق.
            </Callout>
            <p>الدرس مش "تأخّر علشان القانون".</p>
            <p>الدرس: في 99% من الحالات، عندك أداة قانونية مناسبة — لو طلبتها صح. الـ Pen/Trap بياخد ساعات. الـ warrant بياخد يوم. الـ Title III بياخد أسابيع. خطّط من الأول، مش لما الموقف يضغط عليك.</p>
          </Section>
...
FISA Order         Foreign intel surveillance      FISC approval`}</Code>
          ...
          <Section title="غلطات الـ junior">
            <Callout kind="danger" title="اللي بيحصل لما الـ junior يستعجل">
              <ul>
                <li><b>"خد screenshot وخلاص"</b> — مفيش chain of custody، مفيش hash، مفيش متى. الـ defense هيـ destroy الـ evidence ده في 5 دقايق.</li>
                <li><b>كلّم الضحية قبل OGC</b> — قلت معلومات عن investigation سرية، حرقت source.</li>
                <li><b>خلط Title 50 و Title 18</b> — أخدت intel من 702 وحطّيتها في criminal affidavit. الـ AUSA بتلعنك من جدّك.</li>
                <li><b>"مش محتاج warrant، الـ provider هيدّيلي"</b> — أيوة هيدّيلك Subscriber info فقط. أي حاجة فيها content من غير warrant = suppression.</li>
                <li><b>ما وثّقتش ليه أخدت القرار ده</b> — بعد سنتين في trial، مش هتفتكر. بدون الـ documentation، الـ reasoning بتاعك مش موجود.</li>
              </ul>
            </Callout>
          </Section>

          <Section title="الخلاصة الناشفة">
            <p>القانون مش "حاجز" قدام شغلك. القانون هو شغلك.</p>
            <p>أي analyst شاطر تقنياً وضعيف قانونياً = خطر على فرقته.</p>
            <p>اعرف الـ tool المناسب للموقف، اطلبه من الأول، ووثّق كل خطوة. وما تخافش تسأل OGC. السؤال مش ضعف — السؤال هو اللي بيحميك.</p>
            <p>اكتبها على الحيطة اللي في وش السرير: <b>كل قرار قابل للمراجعة. وثّق reasoning قبل ما تنساه.</b></p>
          </Section>
