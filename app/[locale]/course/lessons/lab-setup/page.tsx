...
export default function Page() {
  return (
    <LessonShell slug="lab-setup">
      <L
        ar={<>
          <Section title="لماذا تحتاج مختبراً قبل أي شيء">
            <p>كل شيء في هذه الدورة يفترض أن لديك مكاناً <b>قانونياً وآمناً</b> للتجريب. مختبر منزلي = حواسيب افتراضية معزولة. لا تلمس الإنترنت، لا تلمس شبكة بيتك، لا أحد يتأذى لو شيء انفجر.</p>
...
sudo systemctl enable --now apache2 mysql`}</Code>
          ...
          <Section title="عادات أساسية في المختبر">
            <ol>
              <li><b>Snapshot قبل كل تجربة.</b> اسم واضح: <span className="eng">clean-win10-baseline</span>.</li>
              <li><b>وثّق ما فعلت</b> في ملف نصي بكل VM. النسيان عدوّ التعلم.</li>
              <li><b>لا تربط VM بـ Bridged adapter</b> أبداً إلا إذا كنت تعرف ما تفعل — ذلك يضعها على شبكة بيتك.</li>
              <li><b>اعزل البيانات</b>: لا تنسخ ملفاتك الشخصية إلى VMs.</li>
              <li><b>أوقف</b> VMs عند عدم الاستخدام (تستهلك RAM).</li>
            </ol>
          </Section>
